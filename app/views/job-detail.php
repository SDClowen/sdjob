                    ...
                    <div class="">
                        <h1 class="flex justify-between font-semibold text-xl text-gray-800 dark:text-gray-200">
                            ...
                            <div class="inline-flex self-end">
                                ...
                                {/if}
                                {else}
                                <a href="#" data-url="/auth" class="mr-3 flex items-center justify-center px-4 py-2 text-md font-medium text-white rounded-lg hover:shadow-md transition-colors duration-200 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-red-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 mr-2 -ml-1" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                        <path d="M8 9a3 3 0 100-6 3 3 0 000 6zM8 11a6 6 0 016 6H2a6 6 0 016-6zM16 7a1 1 0 10-2 0v1h-1a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V7z" />
                                    </svg>
                                    Başvur
