    ...
    <div class="overflow-hidden">
        <div class="border-gray-200 px-4 py-5 sm:p-0">
            <dl class="sm:divide-y sm:divide-gray-200">
                ...
                <div class="py-3 sm:py-5 sm:px-6 text-md font-medium text-gray-500">
                    {strdate($contact->createdAt, "d.m.y hh:mm:s")}
                </div>
            </dl>
        </div>
    </div>
