<div class="flex flex-wrap -mx-6">
    <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
        <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
            ...
            <div class="mx-5">
                ...
                <div class="text-gray-500">Kullanıcı</div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
        <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
            ...
            <div class="mx-5">
                <h4 class="text-2xl font-semibold text-gray-700">{$jobCount}</h4>
                <div class="text-gray-500">İlan</div>
            </div>
        </div>
    </div>
    ...
    <div class="w-full px-6 mt-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
        <div class="flex items-center px-5 py-6 bg-white rounded-md shadow-sm">
            ...
            <div class="mx-5">
                <h4 class="text-2xl font-semibold text-gray-700">{$jobApplicantsCount}</h4>
                <div class="text-gray-500">Başvuru</div>
            </div>
        </div>
    </div>
</div>
...
<div class="flex flex-col mt-8 hidden">
    <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
        <div class="inline-block min-w-full overflow-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
            <table class="min-w-full" id="users-applicants" datatable="true" datatable-ajax="/admin/account/users">
                <thead>
                    <tr>
