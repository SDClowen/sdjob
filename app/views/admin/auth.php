        ...
        <section class="bg-gray-50 dark:bg-gray-900">
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img width="220" src="http://localhost:8000/public/logo.png" alt="logo">
                </a>
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="/admin/auth" method="post" role="form" data-content=".message">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="#" class="text-sm font-medium text-red-600 hover:underline dark:text-red-500">Şifremi Unuttum</a>
                            </div>
