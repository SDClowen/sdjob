<div style="background-color: #002559; font-family: Poppins" class="relative mb-12">
    ...
    <div class="flex items-center justify-start absolute w-full h-full left-0 top-0">
        <div class="ms-24">
            <span class="text-white text-[50px] font-semibold block">{lang('applicant.register')}</span>
        </div>
    </div>
</div>
...
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 lg:py-16 px-4 mx-auto m-6 max-w-screen-md">
        <h2 class="hidden mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">{lang('applicant.register')}</h2>
        <p class="hidden mb-8 lg:mb-16 font-light text-center text-white0 dark:text-gray-400 sm:text-xl">Personel Üyeliği Oluşturun</p>
        <form role="form" method="post" data-content=".message" action="/register/applicant" class="space-y-4">
            <div>
                <label for="name" class="block mb-2 font-medium text-gray-900 dark:text-gray-300">Adınız *</label>
                <input name="name" type="text" id="name" class="shadow-sm bg-white border border-gray-300 text-gray-900 rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" >
            </div>
            <div>
                <label for="surname" class="block mb-2 font-medium text-gray-900 dark:text-gray-300">Soyadınız *</label>
                <input name="surname" type="text" id="surname" class="block p-2 w-full text-gray-900 bg-white rounded-md border border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" >
            </div>
            <div>
